...
const eslintPackageJSONTypeScript = {
    devDependencies: Object.assign(Object.assign({}, eslintPackageJSONVanilla.devDependencies), { '@typescript-eslint/eslint-plugin': '^5.42.0', '@typescript-eslint/parser': '^5.42.0' }),
};
...
const generateVanilla = async () => {
    ...
    let packageJSON = loadJSONConfig(path.join(TEMPLATE_PATH, answers.useTypescript ? 'package-ts.json' : 'package.json'));
